...
<p><?php printf(esc_html__('Thanks for creating an account on %1$s. Your username is %2$s. You can access your account area to view orders at: %3$s', 'woocommerce'), esc_html($blogname), '<strong>' . esc_html($user_login) . '</strong>', make_clickable(esc_url($FRONTEND_BASE_URL + '/orders'))); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped 
		?></p>
